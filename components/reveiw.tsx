...
const desktopPositions = [
    { left: "2%", top: "18.5%", width: "35%", zIndex: 20 }, // 0: Large Left
...
export default function Review() {
    ...
    useEffect(() => {
        ...
        }, 2500); // 1.5s transition + 1s pause = 2.5s total cycle
    ...
    return (
        <section className="py-20 lg:py-32 bg-white overflow-hidden font-jakarta">
            <div className="container mx-auto px-4">
                ...
                {/* Desktop & Tablet Layout - Using clean CSS Grid for exact non-clashing placement */}
                <div className="hidden md:grid grid-cols-12 grid-rows-6 relative w-full max-w-5xl mx-auto aspect-[1.8] mt-16 md:mt-24">
                    <div className="absolute inset-0 pointer-events-none z-10">
                        {PROFILES.map((profile, idx) => {
                            ...
                            return (
                                <div
                                    key={idx}
                                    className={`absolute rounded-full aspect-square overflow-hidden pointer-events-auto ${posIndex === 0 ? "shadow-2xl" : "shadow-sm"
                                        }`}
                                    style={{
                                        left: pos.left,
                                        top: pos.top,
                    ...
                    {/* Quote Block Desktop (Row 4 out of 6 places it exactly below the center of the arc safely) */}
                    ...
                    <div className="relative w-full aspect-square max-w-md mx-auto">
                        {PROFILES.map((profile, idx) => {
                            ...
                            return (
                                <div
                                    key={idx}
                                    className={`absolute rounded-full aspect-square overflow-hidden ${posIndex === 0 ? "shadow-2xl" : "shadow-sm"
                                        }`}
                                    style={{
                                        left: pos.left,
                                        top: pos.top,
